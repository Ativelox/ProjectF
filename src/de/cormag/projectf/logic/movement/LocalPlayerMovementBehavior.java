...
public class LocalPlayerMovementBehavior implements IPlayerMovementBehavior{
	...
	public void update(GameTime gameTime) {
		...
		//TODO: in general remove those collision codes from creature and move them to icanmove or a seperate collisionmanager, 
		//so you are no longer bound to being a creature in order to check for collisions
