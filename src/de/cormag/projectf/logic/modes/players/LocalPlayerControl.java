...
public class LocalPlayerControl implements IModeControl {
	...
	/**
	 * Creates a new local player control object, which lets the object move by
	 * using w, a, s, d.
	 * 
	 * @param parent
	 *            the entity which is controlled by this object
	 ...
	 *            Move order receiving behavior object
	 * @param keyManager
	 *            the key manager that is used to set the controls for this
	 *            object
	 */
	public LocalPlayerControl(final ICanMove parent, final IPlayerMovementBehavior moveReceiver,
			final LocalPlayerAttackBehavior localPlayerAttackbehavior, final KeyManager keyManager) {
