...
public class Assets {
	...
	public static void init() {
		...
		SpriteSheet characterSprites = new SpriteSheet(ImageLoader.loadImage("charactersprites.png")); // TODO
																										...
																										// to
																										// pfpf
		SpriteSheet house_sheet = new SpriteSheet(ImageLoader.loadImage("Houses.png"));// TODO
																						// change
																						// png
																						// to
																						// pfpf
		SpriteSheet modernage = new SpriteSheet(ImageLoader.loadImage("modernage.png")); // TODO
																							// change
																							// png
																							// to
																							// pfpf
		SpriteSheet treesAndBushes = new SpriteSheet(ImageLoader.loadImage("TreesAndBushes.png")); // TODO
																									// change
																									// png
																									// to
																									// pfpf
		SpriteSheet weaponSkills = new SpriteSheet(ImageLoader.loadImage("Weapon Skills/WeaponSkillOne.png")); // TODO
																												// change
																												// png
																												// to
																												// pfpf
